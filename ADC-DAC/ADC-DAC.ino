...
//#define FREQUENCY 3007   // Hz
//Parameters.ADC_frequency
 ...
 */
 ...
 int32_t Delay_loop = max((int32_t)(BEST_N_VAL*(1-TIME_1VAL*Parameters.ADC_frequency)/Parameters.ADC_frequency*1e6), 0);    // us
...
void setup() {
    ...
    //uint32_t pdb_trigger_frequency = Parameters.ADC_frequency;
